...
//
//    @Nested
//    @DisplayName("Validate Collection")
//    protected class testValidateCollection {
//        @Test
//        @DisplayName("Acceptable Inputs - Expect Nothing")
//        public void testValidateCollection_acceptableInputs_expectNothing() throws Throwable {
//            String serverId = UUID.randomUUID().toString();
//            Setting testActiveSetting = new Setting();
//            testActiveSetting.setId(UUID.randomUUID().toString());
//            testActiveSetting.setType(SettingType.BOOLEAN);
...
//            testCollection.setId(serverId);
//            testCollection.setName("test");
//
//            validationService.validateCollection(testCollection, serverId, false);
//
//            Mockito.verify(validationService, Mockito.times(1)).validateCollection(Mockito.any(Collection.class), Mockito.any(), Mockito.anyBoolean());
//        }
//
//        @Test
//        @DisplayName("Invalid Id Create - Expect Error")
//        public void testValidateCollection_invalidIdCreate_expectError() throws Throwable {
//            Collection testCollection = new Collection();
//            testCollection.setId(UUID.randomUUID().toString());
//            testCollection.setName("test");
//
//            Assertions.assertThrows(OverseerUnprocessableException.class, () -> validationService.validateCollection(testCollection, null, true));
//
//            Mockito.verify(validationService, Mockito.times(1)).validateCollection(Mockito.any(Collection.class), Mockito.any(), Mockito.anyBoolean());
//        }
//
//        @Test
//        @DisplayName("Missing Id Update - Expect Error")
//        public void testValidateCollection_invalidIdUpdate_expectError() throws Throwable {
//            Collection testCollection = new Collection();
//            testCollection.setName("test");
//
//            Assertions.assertThrows(OverseerBadRequestException.class, () -> validationService.validateCollection(testCollection, UUID.randomUUID().toString(), false));
//
//            Mockito.verify(validationService, Mockito.times(1)).validateCollection(Mockito.any(Collection.class), Mockito.any(), Mockito.anyBoolean());
//        }
//
//        @Test
//        @DisplayName("Missing Name - Expect Error")
//        public void testValidateCollection_missingName_expectError() throws Throwable {
//            Collection testCollection = new Collection();
//
//            Assertions.assertThrows(OverseerBadRequestException.class, () -> validationService.validateCollection(testCollection, null, true));
//
//            Mockito.verify(validationService, Mockito.times(1)).validateCollection(Mockito.any(Collection.class), Mockito.any(), Mockito.anyBoolean());
//        }
//    }
