...
//            testServer.setSettings(Set.of(testSetting));
//
//            Mockito.doReturn(testServer).when(serverService).getServerById(Mockito.any(), Mockito.anyBoolean());
//
...
//            Mockito.verify(serverService, Mockito.times(1)).getServerById(Mockito.any(), Mockito.anyBoolean());
//        }
//
//        @Test
//        @DisplayName("Not Found - Expect Error")
//        public void testGetApiKey_notFound_expectError() throws Throwable {
//            Mockito.doThrow(OverseerNotFoundException.class).when(serverService).getServerById(Mockito.any(), Mockito.anyBoolean());
//
//            String uri = BASE_MAPPING + "/{id}";
...
//            testServer.setSettings(Set.of(testSetting));
//
//            Mockito.doReturn(List.of(testServer)).when(serverService).getAllServers(false);
//
...
//            Mockito.doThrow(OverseerNoContentException.class).when(serverService).getAllServers(Mockito.anyBoolean());
//
