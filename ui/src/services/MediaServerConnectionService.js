...
let clientInformation = {
    ...
    device: "testDevice",            // The type of device your application is running on
    version: "1",                               // Version of your application
    forwardUrl: "http://localhost:8080",       // Optional - Url to forward back to after signing in.
...
export async function testPlexAccess() {
